...
INSTALLED_APPS = [
    ...
    'rest_framework_simplejwt',  # SimpleJWT per l'autenticazione JWT
]
...
DATABASES = {
     'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'user_management_db'),
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "user_management_service.serializers.CustomTokenObtainPairSerializer",
...
# Specifica il modello utente personalizzato
