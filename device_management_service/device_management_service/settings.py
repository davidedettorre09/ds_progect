"""
Django settings for device_management_service project.
...
# Configurazione per Django REST Framework e JWT
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Autenticazione JWT
    ),
...
# Configurazione di SimpleJWT per la gestione dei token
SIMPLE_JWT = {
